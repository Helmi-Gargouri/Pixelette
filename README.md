...
Projet développé par 5 étudiants passionnés en informatique.

### Liens Utiles

- 🐛 **Issues** : [GitHub Issues](https://github.com/votre-username/pixelette/issues)
- 📧 **Email** : contact@pixelette.example.com
- 💬 **Discussions** : [GitHub Discussions](https://github.com/votre-username/pixelette/discussions)
