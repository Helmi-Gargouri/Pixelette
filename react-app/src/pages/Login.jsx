...
const Login = () => {
  ...
  return (
    <>
      ...
      {/* Section principale qui prend toute la hauteur et centre le contenu */}
      <section className="hero-wrapper auth-hero" style={{ 
        ...
        marginTop: '-80px', // Compense le header
        paddingTop: '100px' // Réajuste pour le header
      }}>
        {/* Fond décoratif */}
        ...
        <div className="container" style={{ 
          ...
          alignItems: 'center',
          minHeight: 'calc(100vh - 180px)' // Ajuste pour header et footer
        }}>
          <div className="row justify-content-center w-100"> {/* w-100 pour prendre toute la largeur */}
            <div className="col-xl-4 col-lg-5 col-md-6 col-sm-8"> {/* Taille réduite pour mieux centrer */}
              {/* Carte de login */}
              <div className="hero-style1 auth-form-wrapper" style={{ 
                ...
                textAlign: 'center',
                width: '100%',
                maxWidth: '420px', // Largeur fixe pour cohérence
