...
class TempAuthStorage(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not self.expires_at:
            self.expires_at = timezone.now() + timezone.timedelta(minutes=5)  # Expire après 5 minutes
...
class Utilisateur(models.Model): 
    ...
    role = models.CharField(max_length=10, choices=ROLE_CHOICES, default='Artiste', verbose_name="Rôle")
