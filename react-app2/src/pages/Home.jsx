        ...
        <div className="container">
          <div className="row justify-content-between align-items-center">
            <div className="col-lg-8">
                ...
                <h2 className="sec-title text-white">Expositions en vedette</h2>
              </div>
            </div>
            <div className="col-lg-auto">
                <div className="sec-btn wow custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.1s">
                <Link className="btn style2" to="/event">VOIR TOUTES LES EXPOSITIONS</Link>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-4 col-md-6 exhibition-card-wrap">
              <div className="exhibition-card gtop">
                <div className="exhibition-card-thumb">
                  ...
                  <div className="shadow-text">Sculpteur</div>
                </div>
                <div className="exhibition-card-details">
                  ...
                  <h3 className="event-card-title"><Link to="/event">Capturer l'essence de l'art</Link></h3>
                  <Link className="btn style2" to="/event">SCULPTEUR</Link>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 exhibition-card-wrap">
              <div className="exhibition-card gtop">
                ...
                <div className="exhibition-card-details">
                  ...
                  <h3 className="event-card-title"><Link to="/event">Transformer les idées en formes</Link></h3>
                  <Link className="btn style2" to="/event">SCULPTEUR</Link>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 exhibition-card-wrap">
              <div className="exhibition-card gtop">
                ...
                <div className="exhibition-card-details">
                  ...
                  <h3 className="event-card-title"><Link to="/event">Façonner le paysage</Link></h3>
                  <Link className="btn style2" to="/event">SCULPTEUR</Link>
                </div>
              </div>
            </div>
              ...
              <div className="col-xl-6 col-lg-7">
                <div className="title-area text-center mb-0 wow custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.1s">
                  <h2 className="sec-title mb-0 text-white fw-medium">
                    Réservez un événement pour votre musée
                  </h2>
                  <Link to="/contact" className="btn">Billets & Entrée</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="event-area-1 space overflow-hidden bg-smoke">
        <div className="container">
          <div className="row justify-content-lg-between justify-content-center text-lg-start text-center">
            ...
            <div className="col-lg-auto">
                <div className="sec-btn wow custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.1s">
                <Link to="/event" className="btn">VOIR TOUS LES ÉVÉNEMENTS</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row gy-30">
            <div className="col-lg-12">
              <div className="event-card wow custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.1s">
                ...
                <div className="event-card-details">
                  <h3 className="event-card-title"><Link to="/event-details">Y a-t-il des événements uniques ?</Link></h3>
                  <span className="event-card-location">New York, Rodices120/32</span>
                  <Link to="/event" className="btn">RÉSERVER</Link>
                </div>
            ...
            <div className="col-lg-12">
              <div className="event-card wow custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.1s">
                ...
                <div className="event-card-details">
                  <h3 className="event-card-title"><Link to="/event-details">Moments sculptés, émotions capturées</Link></h3>
                  <span className="event-card-location">New York, Rodices120/32</span>
                  <Link to="/event" className="btn">RÉSERVER</Link>
                </div>
                <div className="event-card-thumb">
