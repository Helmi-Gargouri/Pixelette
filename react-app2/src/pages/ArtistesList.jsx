      ...
      <div className="portfolio-standard-area space overflow-hidden">
        <div className="container">
          ...
          {filteredArtistes.length === 0 ? (
            ...
            (() => {
              const columns = distributeArtistes(filteredArtistes)
                              ...
                              <div className="d-flex gap-2 justify-content-center">
                                ...
                                {isAuthenticated && user?.id !== artiste.id && (
                                  <button 
                                    ...
                                    disabled={isLoading}
                                    className={`btn btn-sm ${isFollowing ? 'btn-outline' : ''}`}
                                    style={{ 
                                      padding: '8px 20px',
                                      borderRadius: '8px',
                                      fontSize: '0.9rem',
                                      ...
                                      border: isFollowing ? '2px solid var(--theme-color)' : undefined,
                                      color: isFollowing ? 'var(--theme-color)' : undefined,
