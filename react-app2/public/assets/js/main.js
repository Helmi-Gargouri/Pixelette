(function ($) {
  ...
  */
  ...
  ==================================*/
    ...
    if ($(".global-carousel").length > 0) {
        $(".global-carousel").each(function () {
            ...
            responsive: [
                ...
                console.log('Slick carousel init error (safe to ignore):', error);
            }
        });
    }
    ...
    // Call On Load
    if ($(".hero-custom-dots").length) {
        $(".hero-custom-dots").defaultTab({
            sliderTab: true,
            tabButton: ".tab-btn",
        });
    }
    ...
    $(document).ready((function() {
        function e() {
            var e;
            $(".sticky-wrapper").hasClass("sticky") ? $("#smooth-wrapper").css("padding-top", "0") : (e = $(".nav-header").outerHeight(),
    ...
    const fadeElements = document.querySelectorAll(".fade_top");
